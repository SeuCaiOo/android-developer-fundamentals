...
public class MainActivity extends AppCompatActivity {
    ...
    public void sendNotification() {
        ...
        notifyBuilder.addAction(R.drawable.ic_update,
                getString(R.string.notification_action_update), updatePedingIntent);
    ...
    private NotificationCompat.Builder getNotificationBuilder() {
        ...
        PendingIntent notificationPedingIntent = PendingIntent.getActivity(this,
        ...
        NotificationCompat.Builder notifyBuilder = new NotificationCompat.Builder(this,
                ...
                .setContentIntent(notificationPedingIntent)
                .setAutoCancel(true)
